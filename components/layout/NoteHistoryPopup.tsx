...
interface NoteHistoryPopupProps {
  isOpen: boolean;
  onClose: () => void;
  notes: LeadNote[];
  title: string;
...
export default function NoteHistoryPopup({ isOpen, onClose, notes, title }: NoteHistoryPopupProps) {
          ...
          {notes && notes.length > 0 ? (
            ...
            <div className="flex justify-center items-center h-full">
              <div className="text-center py-8 text-gray-500">
                <RiChatHistoryLine className="w-12 h-12 mx-auto mb-4 text-gray-300" />
                <p>No note history available.</p>
              </div>
            </div>
          )}
        </div>
